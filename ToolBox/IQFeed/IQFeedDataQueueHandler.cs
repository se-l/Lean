...
namespace QuantConnect.ToolBox.IQFeed
{
    ...
    public class IQFeedDataQueueHandler : HistoryProviderBase, IDataQueueHandler, IDataQueueUniverseProvider, IOptionChainProvider
    {
        ...
        public IQFeedDataQueueHandler()
        {
            ...
            LookupClient lookupClient = LookupClientFactory.CreateNew(Config.Get("iqfeed-host", "localhost"), 9100, NumberOfClients);
    ...
    public class HistoryPort : IQLookupHistorySymbolClient
    {
        ...
        private readonly string DataDirectory = Config.Get("data-folder", "../../../Data");
