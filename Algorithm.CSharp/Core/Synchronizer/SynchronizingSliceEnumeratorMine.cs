...
namespace QuantConnect.Algorithm.CSharp.Core.Synchronizer
{
    ...
    /// </summary>
    public class SynchronizingSliceEnumeratorMine : SynchronizingEnumeratorMine<Slice>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SynchronizingSliceEnumeratorMine"/> class
        /// </summary>
        /// <param name="enumerators">The enumerators to be synchronized. NOTE: Assumes the same time zone for all data</param>
        public SynchronizingSliceEnumeratorMine(params IEnumerator<Slice>[] enumerators)
        ...
        /// </summary>
        /// <param name="enumerators">The enumerators to be synchronized. NOTE: Assumes the same time zone for all data</param>
        public SynchronizingSliceEnumeratorMine(IEnumerable<IEnumerator> enumerators) : base((IEnumerable<IEnumerator<Slice>>)enumerators)
        {
        }
