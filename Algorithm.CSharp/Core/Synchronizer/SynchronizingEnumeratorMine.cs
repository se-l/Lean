...
namespace QuantConnect.Algorithm.CSharp.Core.Synchronizer
{
    ...
    /// </summary>
    public abstract class SynchronizingEnumeratorMine<T> : IEnumerator<T>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SynchronizingEnumeratorMine{T}"/> class
        /// </summary>
        ...
        protected SynchronizingEnumeratorMine(params IEnumerator<T>[] enumerators)
        ...
        /// <param name="enumerators">The enumerators to be synchronized. NOTE: Assumes the same time zone for all data</param>
        /// <typeparam name="T">The type of data we want, for example, <see cref="BaseData"/> or <see cref="Slice"/>, ect...</typeparam>
        protected SynchronizingEnumeratorMine(IEnumerable<IEnumerator<T>> enumerators)
        {
