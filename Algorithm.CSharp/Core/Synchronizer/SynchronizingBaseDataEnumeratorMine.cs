...
namespace QuantConnect.Algorithm.CSharp.Core.Synchronizer
{
    ...
    /// </summary>
    public class SynchronizingBaseDataEnumeratorMine : SynchronizingEnumeratorMine<BaseData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SynchronizingBaseDataEnumeratorMine"/> class
        /// </summary>
        /// <param name="enumerators">The enumerators to be synchronized. NOTE: Assumes the same time zone for all data</param>
        public SynchronizingBaseDataEnumeratorMine(params IEnumerator<BaseData>[] enumerators)
        ...
        /// </summary>
        /// <param name="enumerators">The enumerators to be synchronized. NOTE: Assumes the same time zone for all data</param>
        public SynchronizingBaseDataEnumeratorMine(IEnumerable<IEnumerator> enumerators) : base((IEnumerable<IEnumerator<BaseData>>)enumerators)
        {
        }
